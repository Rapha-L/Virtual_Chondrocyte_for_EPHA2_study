function [TransitionResult,storeNewattr] = inSilicoConditions_return2(saturation,attractor_file,init_attr,nodes,inputvalues)
...
%%
    ...
    %attr_init = All_attractors(init_attrNum);
    runs = 100;
    fixedtime = 1000;
...
% output.storeNewattr = storeNewattr;
% output.transitions_to_initAttrs = TransitionResult;
