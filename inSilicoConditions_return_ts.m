function [TransitionResult,timeseries] = inSilicoConditions_return_ts(saturation,runumber,attractor_file,init_attr,nodes,inputvalues)
% Start from the WT attractors, impose perturbed conditions with multiple
% nodes and study effect on chondro state transition.
%This function retun the simulation result and can be called by other scripts, it also save and return the full timseries (evolution of variables over timesteps)
...
%% Define initial chondrocyte state
